...
public class GetValueResults implements android.os.Parcelable
{
  public GetValueResult[] payloads;
  public android.os.ParcelFileDescriptor sharedMemoryFd;
  public static final Creator<GetValueResults> CREATOR = new Creator<GetValueResults>() {
    @Override
    public GetValueResults createFromParcel(android.os.Parcel _aidl_source) {
      GetValueResults _aidl_out = new GetValueResults();
      _aidl_out.readFromParcel(_aidl_source);
      return _aidl_out;
    }
    @Override
    public GetValueResults[] newArray(int _aidl_size) {
      return new GetValueResults[_aidl_size];
    }
  };
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      payloads = _aidl_parcel.createTypedArray(GetValueResult.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
  ...
  public String toString() {
    ...
    return "android.hardware.automotive.vehicle.GetValueResults" + _aidl_sj.toString()  ;
  }
  @Override
  public boolean equals(Object other) {
    if (this == other) return true;
    if (other == null) return false;
    if (!(other instanceof GetValueResults)) return false;
    GetValueResults that = (GetValueResults)other;
