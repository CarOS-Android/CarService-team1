...
public final class SwitchUserResponse {
    /**
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != SwitchUserResponse.class) {
            return false;
        }
        SwitchUserResponse other = (SwitchUserResponse)otherObject;
    ...
    public final String toString() {
        ...
        builder.append(SwitchUserStatus.toString(this.status));
    ...
    public static final java.util.ArrayList<SwitchUserResponse> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<SwitchUserResponse> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                SwitchUserResponse _hidl_vec_element = new SwitchUserResponse();
                ((SwitchUserResponse) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 32);
    ...
    public final void readEmbeddedFromParcel(
        ...
        status = _hidl_blob.getInt32(_hidl_offset + 8);
        errorMessage = _hidl_blob.getString(_hidl_offset + 16);
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<SwitchUserResponse> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 8, status);
        _hidl_blob.putString(_hidl_offset + 16, errorMessage);
    }
};
