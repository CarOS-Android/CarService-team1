...
public class SetValueRequests implements android.os.Parcelable
{
  public SetValueRequest[] payloads;
  public android.os.ParcelFileDescriptor sharedMemoryFd;
  public static final Creator<SetValueRequests> CREATOR = new Creator<SetValueRequests>() {
    @Override
    public SetValueRequests createFromParcel(android.os.Parcel _aidl_source) {
      SetValueRequests _aidl_out = new SetValueRequests();
      _aidl_out.readFromParcel(_aidl_source);
      return _aidl_out;
    }
    @Override
    public SetValueRequests[] newArray(int _aidl_size) {
      return new SetValueRequests[_aidl_size];
    }
  };
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      payloads = _aidl_parcel.createTypedArray(SetValueRequest.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
  ...
  public String toString() {
    ...
    return "android.hardware.automotive.vehicle.SetValueRequests" + _aidl_sj.toString()  ;
  }
  @Override
  public boolean equals(Object other) {
    if (this == other) return true;
    if (other == null) return false;
    if (!(other instanceof SetValueRequests)) return false;
    SetValueRequests that = (SetValueRequests)other;
