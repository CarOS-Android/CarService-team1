...
public final class RemoveUserRequest {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != RemoveUserRequest.class) {
            return false;
        }
        RemoveUserRequest other = (RemoveUserRequest)otherObject;
        if (this.requestId != other.requestId) {
            return false;
        }
        if (!android.os.HidlSupport.deepEquals(this.removedUserInfo, other.removedUserInfo)) {
            return false;
        }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.removedUserInfo),
    ...
    public final String toString() {
        ...
        builder.append(", .removedUserInfo = ");
        builder.append(this.removedUserInfo);
    ...
    public static final java.util.ArrayList<RemoveUserRequest> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<RemoveUserRequest> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                RemoveUserRequest _hidl_vec_element = new RemoveUserRequest();
                ((RemoveUserRequest) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 48);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((UserInfo) removedUserInfo).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 4);
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<RemoveUserRequest> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        removedUserInfo.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 4);
