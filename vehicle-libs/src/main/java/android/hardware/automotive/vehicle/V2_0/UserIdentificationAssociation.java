...
public final class UserIdentificationAssociation {
    public int type;
    public int value;
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != UserIdentificationAssociation.class) {
            return false;
        }
        UserIdentificationAssociation other = (UserIdentificationAssociation)otherObject;
    ...
    public final String toString() {
        ...
        builder.append("{");
        builder.append(".type = ");
        builder.append(UserIdentificationAssociationType.toString(this.type));
        builder.append(", .value = ");
        builder.append(UserIdentificationAssociationValue.toString(this.value));
        builder.append("}");
    ...
    public static final java.util.ArrayList<UserIdentificationAssociation> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<UserIdentificationAssociation> _hidl_vec = new java.util.ArrayList();
    ...
    public final void readEmbeddedFromParcel(
        ...
        value = _hidl_blob.getInt32(_hidl_offset + 4);
    }
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<UserIdentificationAssociation> _hidl_vec) {
