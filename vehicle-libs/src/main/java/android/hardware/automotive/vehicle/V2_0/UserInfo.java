...
public final class UserInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != UserInfo.class) {
            return false;
        }
        UserInfo other = (UserInfo)otherObject;
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                android.os.HidlSupport.deepHashCode(this.userId),
    ...
    public final String toString() {
        ...
        builder.append(UserFlags.toString(this.flags));
        builder.append("}");
    ...
    public static final java.util.ArrayList<UserInfo> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<UserInfo> _hidl_vec = new java.util.ArrayList();
    ...
    public final void readEmbeddedFromParcel(
        ...
        userId = _hidl_blob.getInt32(_hidl_offset + 0);
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<UserInfo> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 0, userId);
