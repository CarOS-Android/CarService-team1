...
public final class UserIdentificationSetAssociation {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != UserIdentificationSetAssociation.class) {
            return false;
        }
        UserIdentificationSetAssociation other = (UserIdentificationSetAssociation)otherObject;
    ...
    public final String toString() {
        ...
        builder.append(UserIdentificationAssociationSetValue.toString(this.value));
        builder.append("}");
    ...
    public static final java.util.ArrayList<UserIdentificationSetAssociation> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<UserIdentificationSetAssociation> _hidl_vec = new java.util.ArrayList();
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<UserIdentificationSetAssociation> _hidl_vec) {
