...
public class VehiclePropErrors implements android.os.Parcelable
{
  public VehiclePropError[] payloads;
  public android.os.ParcelFileDescriptor sharedMemoryFd;
  public static final Creator<VehiclePropErrors> CREATOR = new Creator<VehiclePropErrors>() {
    @Override
    public VehiclePropErrors createFromParcel(android.os.Parcel _aidl_source) {
      VehiclePropErrors _aidl_out = new VehiclePropErrors();
      _aidl_out.readFromParcel(_aidl_source);
      return _aidl_out;
    }
    @Override
    public VehiclePropErrors[] newArray(int _aidl_size) {
      return new VehiclePropErrors[_aidl_size];
    }
  };
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      payloads = _aidl_parcel.createTypedArray(VehiclePropError.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
  ...
  public String toString() {
    ...
    return "android.hardware.automotive.vehicle.VehiclePropErrors" + _aidl_sj.toString()  ;
  }
  @Override
  public boolean equals(Object other) {
    if (this == other) return true;
    if (other == null) return false;
    if (!(other instanceof VehiclePropErrors)) return false;
    VehiclePropErrors that = (VehiclePropErrors)other;
