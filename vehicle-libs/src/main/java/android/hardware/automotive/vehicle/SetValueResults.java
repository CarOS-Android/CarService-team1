...
public class SetValueResults implements android.os.Parcelable
{
  public SetValueResult[] payloads;
  public android.os.ParcelFileDescriptor sharedMemoryFd;
  public static final Creator<SetValueResults> CREATOR = new Creator<SetValueResults>() {
    @Override
    public SetValueResults createFromParcel(android.os.Parcel _aidl_source) {
      SetValueResults _aidl_out = new SetValueResults();
      _aidl_out.readFromParcel(_aidl_source);
      return _aidl_out;
    }
    @Override
    public SetValueResults[] newArray(int _aidl_size) {
      return new SetValueResults[_aidl_size];
    }
  };
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      payloads = _aidl_parcel.createTypedArray(SetValueResult.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
  ...
  public String toString() {
    ...
    return "android.hardware.automotive.vehicle.SetValueResults" + _aidl_sj.toString()  ;
  }
  @Override
  public boolean equals(Object other) {
    if (this == other) return true;
    if (other == null) return false;
    if (!(other instanceof SetValueResults)) return false;
    SetValueResults that = (SetValueResults)other;
