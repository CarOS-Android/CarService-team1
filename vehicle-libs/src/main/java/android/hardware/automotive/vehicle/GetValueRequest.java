...
public class GetValueRequest implements android.os.Parcelable
{
  ...
  public static final Creator<GetValueRequest> CREATOR = new Creator<GetValueRequest>() {
    @Override
    public GetValueRequest createFromParcel(android.os.Parcel _aidl_source) {
      GetValueRequest _aidl_out = new GetValueRequest();
      _aidl_out.readFromParcel(_aidl_source);
      return _aidl_out;
    }
    @Override
    public GetValueRequest[] newArray(int _aidl_size) {
      return new GetValueRequest[_aidl_size];
    }
  };
  ...
  public String toString() {
    ...
    return "android.hardware.automotive.vehicle.GetValueRequest" + _aidl_sj.toString()  ;
  }
  @Override
  public boolean equals(Object other) {
    if (this == other) return true;
    if (other == null) return false;
    if (!(other instanceof GetValueRequest)) return false;
    GetValueRequest that = (GetValueRequest)other;
  ...
  @Override
  public int hashCode() {
    return java.util.Arrays.deepHashCode(java.util.Arrays.asList(requestId, prop).toArray());
  }
  @Override
