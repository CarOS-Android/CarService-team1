...
public class GetValueRequests implements android.os.Parcelable
{
  public GetValueRequest[] payloads;
  public android.os.ParcelFileDescriptor sharedMemoryFd;
  public static final Creator<GetValueRequests> CREATOR = new Creator<GetValueRequests>() {
    @Override
    public GetValueRequests createFromParcel(android.os.Parcel _aidl_source) {
      GetValueRequests _aidl_out = new GetValueRequests();
      _aidl_out.readFromParcel(_aidl_source);
      return _aidl_out;
    }
    @Override
    public GetValueRequests[] newArray(int _aidl_size) {
      return new GetValueRequests[_aidl_size];
    }
  };
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      payloads = _aidl_parcel.createTypedArray(GetValueRequest.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
  ...
  public String toString() {
    ...
    return "android.hardware.automotive.vehicle.GetValueRequests" + _aidl_sj.toString()  ;
  }
  @Override
  public boolean equals(Object other) {
    if (this == other) return true;
    if (other == null) return false;
    if (!(other instanceof GetValueRequests)) return false;
    GetValueRequests that = (GetValueRequests)other;
