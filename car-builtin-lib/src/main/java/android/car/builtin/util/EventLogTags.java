 ...
 * Source file: packages/services/Car/car-builtin-lib/src/android/car/builtin/util/EventLogTags.logtags
 */
...
public class EventLogTags {
  ...
  public static void writeCarHelperSvcConnected() {
    android.util.EventLog.writeEvent(CAR_HELPER_SVC_CONNECTED);
  }
  ...
  public static void writeCarUserSvcCreateUserReq(String safeName, String userType, int flags, int timeout, int hascallerrestrictions) {
    android.util.EventLog.writeEvent(CAR_USER_SVC_CREATE_USER_REQ, safeName, userType, flags, timeout, hascallerrestrictions);
  }
  ...
  public static void writeCarUserHalGetUserAuthResp(Object[] valuesanderror) {
    android.util.EventLog.writeEvent(CAR_USER_HAL_GET_USER_AUTH_RESP, valuesanderror);
  }
  ...
  public static void writeCarUserHalSetUserAuthResp(Object[] valuesanderror) {
    android.util.EventLog.writeEvent(CAR_USER_HAL_SET_USER_AUTH_RESP, valuesanderror);
  }
  ...
  public static void writeCarUserMgrAddListener(int uid, String packageName, int hasFilter) {
    android.util.EventLog.writeEvent(CAR_USER_MGR_ADD_LISTENER, uid, packageName, hasFilter);
  }
  ...
  public static void writeCarPwrMgrStateChange(int state) {
    android.util.EventLog.writeEvent(CAR_PWR_MGR_STATE_CHANGE, state);
  }

  public static void writeCarPwrMgrGarageMode(int status) {
    android.util.EventLog.writeEvent(CAR_PWR_MGR_GARAGE_MODE, status);
  }

  public static void writeCarPwrMgrPwrPolicyChange(String policy) {
    android.util.EventLog.writeEvent(CAR_PWR_MGR_PWR_POLICY_CHANGE, policy);
  }

  public static void writeCarPwrMgrStateReq(int state, int param) {
    android.util.EventLog.writeEvent(CAR_PWR_MGR_STATE_REQ, state, param);
  }
}
