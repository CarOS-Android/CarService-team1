...
public final class Car {
     ...
     *  should check both this and {@link Build.VERSION#SDK_INT} before using
     ...
     * {@link Build.VERSION#SDK_INT}.
     *
     * <p>It will reset to {@code 0} whenever {@link Build.VERSION#SDK_INT} is updated
     * and will increase by {@code 1} if car builtin or other car platform part is changed with the
     * same {@link Build.VERSION#SDK_INT}. Client should check this version to use APIs
     ...
     * {@link ExperimentalFeature} annotations.
     *
     * <p>Example usage:
    ...
    /**
     * Permission necessary to access Car FRAGRANCE APIs.
     *
     * @hide
     */
    @SystemApi
    @AddedInOrBefore(majorVersion = 33)
    public static final String PERMISSION_CAR_FRAGRANCE =
            "android.car.permission.CAR_FRAGRANCE";
